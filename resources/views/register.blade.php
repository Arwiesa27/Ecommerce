  ...
  <body>
    <div class="login-box">
      ...
      <form action="/daftar/create" method="post">
        @csrf
        <div class="user-box">
            <input required="" type="text" name="nama" id="nama" value="" />
        ...
        <center>
            <button class="btn btn-primary mb-2"><input style="border: none" class="bg-transparent text-white" type="submit" value="Daftar"></button>
        </center>
      </form>
    </div>
  </body>
